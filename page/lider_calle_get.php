     ...
     if (is_countable($datos)) {   
        ...
        if ($datos['rol_id'] == 1) {            
            ...
            if (isset($_POST['jefe_calle_id'])) {
                ...
                $resultado = $conexion->prepare('SELECT j.jefe_calle_id, j.ci_ps, j.nombre, j.apellido, j.correo, j.manzana_id, u.usuario_id, u.nombre_usuario, u.rol_id FROM jefe_calle as j
