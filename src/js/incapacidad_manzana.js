/*__________________________________________________DATA TABLE ____________________________________________________________________*/

$(document).ready(function(){
    var dataTable = $('#datos_incapacidad').DataTable({
        ...
        buttons: [      //botones para exportar la tabla
            {
                ...
                title: 'Listado de Personas con Incapacidad en la Manzana',    //Listado de Manzanas.xlsx
            ...
            },
            {
                ...
                title: 'Listado de Personas con Incapacidad en la Manzana',
